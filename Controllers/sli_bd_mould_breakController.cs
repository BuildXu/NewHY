...
namespace WebApi_SY.Controllers
{
    public class sli_bd_mould_breakController : ApiController
    {
        ...
        public async Task<object> mould_break_Insert([Microsoft.AspNetCore.Mvc.FromBody] sli_bd_mould_break option)
        {
        ...
        [System.Web.Http.HttpPost]
        public async Task<object> mould_break_Update([Microsoft.AspNetCore.Mvc.FromBody] sli_bd_mould_break option)
        {
            try
            {
                var context = new YourDbContext();
        ...
        [System.Web.Http.HttpPost]
        public async Task<object> mould_break_Delete(List<int> id)
        {
            try
            {
                var context = new YourDbContext();
        ...
        public IHttpActionResult GetTableBymould_break(string Fnumber = null, string Fname = null)
        {
            var context = new YourDbContext();
