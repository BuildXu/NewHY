            ...
            try
            {
                ...
                if (bLogin)
                {
                   ...
                   // var FcustomerNumer = context.Sli_bd_customer_view.FirstOrDefault(p => p.FNAME == heard.FCustomerName); //根据客户名称查询客户代码
                    var entity = context.sli_pur_instock.Where(p => p.FID == id);   //获取表体多行数据
                    ...
                    rootObject.Modelpur.FSaleOrderEntry.Clear();
                    ...
                    foreach (var entitydata in entityList)
                    {
                        ...
                        newEntry.FStockChild = new Child { FNumber = "100" };
                        newEntry.FSettleChilds = new Child { FNumber = "100" };
                        newEntry.FSupplyChild = new Child { FNumber = "100" };
                        ...
                        newEntry.FsliMetel = new Child { FNumber = entitydata.fsliMetal };
                        ...
                        rootObject.Modelpur.sli.Add(newEntry);
                    }
