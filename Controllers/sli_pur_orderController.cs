...
namespace WebApi_SY.Controllers
{
    ...
    public class sli_pur_orderController : ApiController
    {
        ...
        public IHttpActionResult GetHeaderPurorder(int page = 1, int pageSize = 10)
        {
            var context = new YourDbContext();
            var query = context.Sli_pur_po_view;
            ...
            try
            {
                ...
                if (bLogin)
                {
                    ...
                    foreach (var entitydata in entityList)
                    {
                        ...
                        newEntry.FPriceUnitId = new NumberField { FNumber = "Pcs" };
