...
{
    public class sli_prd_processTicket
    {
        ...
        public virtual ICollection<sli_prd_processTicketEntry> sli_prd_processTicketEntry { get; set; }
    }

    public class sli_prd_processTicketEntry
    {
        public int id { get; set; }
